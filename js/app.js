...
var firstRandomnlyGeneratedImageMarkup = document.getElementsByTagName(
  "img"
)[0];
var secondRandomnlyGeneratedImageMarkup = document.getElementsByTagName(
  "img"
)[1];
var thirdRandomnlyGeneratedImageMarkup = document.getElementsByTagName(
  "img"
)[2];
...
var displayThreeRandomnlyGeneratedImages = function() {
  ...
  while (firstRandomnlyGeneratedIndex === secondRandomnlyGeneratedIndex) {
    firstRandomnlyGeneratedIndex = generateRandomNumberForImageArray();
  }
  var thirdRandomnlyGeneratedIndex = generateRandomNumberForImageArray();
  while (
    thirdRandomnlyGeneratedIndex === firstRandomnlyGeneratedIndex ||
    thirdRandomnlyGeneratedIndex === secondRandomnlyGeneratedIndex
  ) {
    thirdRandomnlyGeneratedIndex = generateRandomNumberForImageArray();
  }

  var firstRandomnlyGeneratedImage =
    Product.arrayOfImageFilePaths[firstRandomnlyGeneratedIndex];
  var secondRandomnlyGeneratedImage =
    Product.arrayOfImageFilePaths[secondRandomnlyGeneratedIndex];
  var thirdRandomnlyGeneratedImage =
    Product.arrayOfImageFilePaths[thirdRandomnlyGeneratedIndex];
  firstRandomnlyGeneratedImageMarkup.src =
    firstRandomnlyGeneratedImage.imageFilename;
  secondRandomnlyGeneratedImageMarkup.src =
    secondRandomnlyGeneratedImage.imageFilename;
  thirdRandomnlyGeneratedImageMarkup.src =
    thirdRandomnlyGeneratedImage.imageFilename;
};
